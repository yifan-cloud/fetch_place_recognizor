...
int main()
{
  ...
  Mat greyimg;
  greyimg = imread("./images/image6.png",IMREAD_UNCHANGED);

  feature = extracting_feature(greyimg);
  int index;
  index = find_bestmatch(feature,"small_db.yml.gz");
...
void testDatabase(const vector<vector<cv::Mat > > &features)
{
  ...
  for(int i = 0; i < NIMAGES; i++)
  {
    cout<<features[i][10]<<endl;
    db.query(features[i], ret, 4);

    // ret[0] is always the same image in this case, because we added it to the 
    // database. ret[1] is the second best match.

    cout << "Searching for Image " << i << ". " << ret[1].Id << endl;
  }
